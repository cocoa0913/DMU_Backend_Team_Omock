...
<body>
    <div class="main-container">
        ...
        <%
            ...
            if (userCode == null || nickname == null || level == null || cash == null || iconCode == null) {
                return;
            }
            ...
            try (
                ...
                PreparedStatement stmt = conn.prepareStatement("SELECT image_data FROM items WHERE item_code = ?");
            ) {
                stmt.setInt(1, Integer.parseInt(iconCode));
                try (ResultSet rs = stmt.executeQuery()) {
                    if (rs.next()) {
                        byte[] iconData = rs.getBytes("image_data");
                        if (iconData != null) {
