...
<body>
    ...
    <%
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/gomoku_db?useUnicode=true&characterEncoding=utf8", "root", "1234"); // 비밀번호 1234
            ...
            <h3><a href="adminPanel.jsp?userCode=<%= userCode %>">관리자 페이지</a></h3>
